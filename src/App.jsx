...
ВАЖЛИВО: Аналізуй кожен деталь з введених даних. НЕ давай загальних відповідей. Враховуй обмеження: ${restrictionsList.join(', ')}`
    try {
      ...
      // Простий і надійний покроковий план
      const simpleSteps = [
        '1) Визначити конкретну послугу/продукт',
        '2) Підготувати матеріали/реквізит',
        '3) Створити оголошення/пост',
        '4) Знайти перших клієнтів',
        '5) Провести першу роботу та зібрати відгуки'
      ]
      ...
      const lockedParts = [
        ...
        'Покроковий план: ' + simpleSteps.join('\n'),
      ]
